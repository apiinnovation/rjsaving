    ...
    <div class="col-md-4">
        <div class="box box-success box-solid">
            <div class="box-header with-border bg-green-gradient" >
                <h3 class="box-title">แก้ไขคำนำหน้านาม</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                {{ Form::open(['method' => 'put','route' => ['TComMPrefix.update',$row->XVPreCode]])  }}
                    <div class="form-group">
                    {{ Form::label('idgroup','รหัสคำนำหน้านาม : ') }}
                    {{ Form::label('XVPreCode',$row->XVPreCode) }}
                    </div>
                    <div class="form-group">
                    {{ Form::label('lnamegroup','คำนำหน้านาม : ') }}
                    {{ Form::text('XVPreName',$row->XVPreName,['class' => 'form-control']) }}
                    </div>
