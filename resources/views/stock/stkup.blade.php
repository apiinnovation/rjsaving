...
<div class="col-md-10 col-md-offset-1">
    ...
    <form role="form" id="frm" class="form-horizontal" method="post" action="{{ url('stkup_save')}}">
        {{ csrf_field()}}
        ...
        <div class="row">
            <section class="content-header">
                ...
                <a class="btn btn-app btn-app-find pull-right " href="{{ url('/stkup_main')}}">              
                ...
                @if (Auth::user()->XBIsApprove =='1' && @$res_stk[0]->XVAddDocStatus =='1')
                    <button type="button" id="btn_cancel" class="btn btn-app btn-app-cancel pull-right  ">
                    <i class="fa fa-check-square"></i> ไม่อนุมัติ
                    </button>
                ...
                @if( ((@$res_stk[0]->XVAddDocStatus =='1' || @$res_stk[0]->XVAddDocStatus =='') && @$res_stk[0]->XBAddDocSend == false) || @$action =='create')
                    @if (Auth::user()->XBIsSave =='1')
                        ...
                        <button type="button" id="btn_save" class="btn btn-app btn-app-save pull-right  ">
                            <i class="fa fa-file-o"></i> บันทึก
                        </button>
                    @endif
                @endif
                <a class="btn btn-app btn-app-add pull-right  " href="{{ url('/stkup')}}">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                ...
                <div class="col-md-10" style="text-align: right">
                    <h3 class="box-title text-green"> 
                        @if (@$res_stk[0]->XVAddDocStatus =='1' && (@$res_stk[0]->XBAddDocSend == true ))
                            {{'(รออนุมัติ)'}}
                        @elseif (@$res_stk[0]->XVAddDocStatus =='1' )
                            {{'(บันทึก)'}}
                        @elseif (@$res_stk[0]->XVAddDocStatus =='2' )
                            {{'(อนุมัติ)'}}
                        @endif
                    </h3></div>
            </div>
            ...
            <div class="box-body">
                        ...
                        <div class="col-lg-2">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control datepicker " 
                                       ...
                                       name="XDAddDocDate" id="XDAddDocDate" 
                                       value="{{ $doc_date }}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <input type="text" class="form-control" readonly="" 
                                   name="XVAddDocNo" id="XVAddDocNo" 
                                   value="{{ $res_stk[0]->XVAddDocNo or 'Auto' }}" >
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control " style="text-align: right;" readonly="" 
                                   name="XIAddQtyBalance" id="XIAddQtyBalance" 
                                   value="{{ $qtybalance or '' }}" >                            
                        </div>
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control " style="text-align: right;" placeholder="จำนวนเงิน" 
                                   readonly="" 
                                   name="XFAddAmtBalance" id="XFAddAmtBalance" 
                                   value="{{ $amtbalance or '' }}">
                        </div>
                        <div class="col-sm-4">
                ...
                <div class="form-group">                     
                    <div class="row">
                        <label class="col-md-2 control-label " style="text-align: right">เงินเดือน :</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control " style="text-align: right;" readonly="" 
                                   name="XFCusSalary" id="XFCusSalary" 
                                   value="{{ number_format(@$res_cus[0]->XFCusSalary ,2)}}" >                            
                        </div>
        ...
        <div class="box box-success">
            <div class="box-header">
                <h3 class="box-title">ขอเพิ่มหุ้น</h3>
            </div>
            <div class="box-body">
                <div class="form-group">                     
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="input-group">
                                ...
                                <input type="text" class="datepicker form-control" 
                                       data-date-format="dd/mm/yyyy" 
                                       name="XDAddApproveDate" id="XDAddApproveDate"                                        
                ...
                <div class="form-group">                     
                    <div class="row">
                        <label class="col-md-2 control-label required" style="text-align: right">เพิ่มหุ้น(จำนวน) :</label>
                        <div class="col-sm-2">
                            <input type="number" class="form-control " style="text-align: right;" placeholder="" 
                                   name="XIAddQty" id="XIAddQty" 
                                   value="{{ number_format(@$res_stk[0]->XIAddQty,0) }}">
                        </div>
                        <label class="col-md-1 control-label" style="text-align: right">เป็นเงิน : </label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control " style="text-align: right;" readonly="" 
                                   name="XFAddAmount" id="XFAddAmount" value="{{ number_format(@$res_stk[0]->XFAddAmount,2) }}" >
                        </div>
                        <div class="col-sm-4">
                            <input type="text" class="form-control " placeholder="" readonly="" 
                                   name="XVAddAmountTxt" id="XVAddAmountTxt"
                                   value="{{ $addamt_txt or '' }}">
                        </div>
                        <label class="col-md-1 control-label" style="text-align: left">บาท</label>
                    </div>
                ...
                <div class="form-group">
                    <div class="row">
                        <label class="col-md-2 control-label " style="text-align: right">รวมเป็น(หุ้น) :</label>
                        <div class="col-sm-2">
                            <input type="number" class="form-control " style="text-align: right;" placeholder="" readonly="" 
                                   name="XIAddSumQty" id="XIAddSumQty"
                                   value="{{ @number_format($res_stk[0]->XIAddSumQty,0) }}">                            
                        </div>

                        <label class="col-md-1 control-label" style="text-align: right">เป็นเงิน : </label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control " style="text-align: right;" placeholder="" readonly="" 
                                   name="XFAddSumAmount" id="XFAddSumAmount"
                                   value="{{ @number_format($res_stk[0]->XFAddSumAmount,2) }}">
                        </div>
                        <div class="col-sm-4">
                            <input type="text" class="form-control " placeholder="" readonly="" 
                                   name="XVAddSumAmountTxt" id="XVAddSumAmountTxt"
                ...
                <div class="form-group">
                    <div class="row">         
                        ...
                        <div class="col-md-9">
                            <input type="text" class="form-control" placeholder="ระบุเหตุผลกรณีไม่ผ่าน" name="XVAddRemark" id="XVAddRemark" 
                                   value="{{ $res_stk[0]->XVAddRemark or '' }}">
                        </div> 
                    </div>
                </div>
...
$(document).ready(function () {
    ...
    $( "form" ).submit(function( event ) {
        var $salary = $('#XFCusSalary').val().replace(/,/g, "");
        var $sum_amt = $('#XFAddSumAmount').val().replace(/,/g, "");
        
        console.log($sum_amt,parseFloat($salary))
        
        if ($sum_amt =='' || parseFloat($sum_amt) == 0){
            swal("กรุณากรอกจำนวนหุ้นที่ต้องการเพิ่ม", "", "error")
            .then((value) => {
                $('#XIAddQty').select();
            });
        ...
        if (parseFloat($sum_amt) >= parseFloat($salary) ){
            swal("ไม่สามารถเพิ่มหุ้นได้ เนื่องจากมูลค่ารวมมากกว่าเงินเดือน", "", "error")
            .then((value) => {
                $('#XIAddQty').select();
             });
...
//        event.preventDefault();
    ...
    $('#modalForm').on('show.bs.modal', function (event) {
        ajaxLoad({!! json_encode(url('/findcus/stkup_getcus/')) !!}, 'modalForm');
    });
    ...
    $('#XVCusCode').keyup(function(e){
        if(e.keyCode == 13)
        {
            ...
            if ($('#XVCusCode').val().length > 0 ){
                url = "{{URL::to('/stkup_getcus/')}}"+'/'+$('#XVCusCode').val();
    ...
    var $qty = $('#XIAddQty'),
            $sumqty = $('#XIAddSumQty'),
            $sumamt = $('#XFAddSumAmount'),
            $sumamttxt = $('#XVAddSumAmountTxt'),
            $qtytxt = $('#XVAddAmountTxt'),
            $amount = $('#XFAddAmount'),
            $qtytotal = $('#XIAddQtyBalance')
            ;
    var $price = 200;
    var $newPrice = $('#XVAddAmount');
    ...
    .on('keyup change', function (e)
    {
        if ($.isNumeric($qty.val())) {
            ...
            $sumqty.val(parseInt($qty.val()) + parseInt($qtytotal.val()));
