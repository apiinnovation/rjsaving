            ...
            <div class="box-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                ...
                                <input id="inputdatepicker" class="datepicker form-control-sm" name ="XDCusBdate" data-date-format="mm/dd/yyyy" value={{ $bdate }}>
                            </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                            ...
                            <label class="col-lg-2 col-sm-2">
                                <input type="radio" name="Marr" class="minimal" value="marr1"  <?php if($row->XVCusBankId=1) { checked; } ?> >
                                โสด
                            </label>
                            <label class="col-lg-2 col-sm-2">
                                <input type="radio" name="Marr" class="minimal" value="marr2" <?php if($row->XVCusBankId=2) { checked; } ?>>
                                สมรส
                            </label>
                            <label class="col-lg-2 col-sm-2">
                                <input type="radio" name="Marr" class="minimal" value="marr3" <?php if($row->XVCusBankId=3) { checked; } ?> >
                                หย่า/หม้าย
                            </label>
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-12">
                            ...
                            <label class="col-lg-2 col-sm-2">
                                <input type="radio" name="XVCusAddressMarriage" class="minimal" checked>
                                ทำที่ RJ.
                            </label>
                            <label class="col-lg-2 col-sm-2">
                                <input type="radio" name="XVCusAddressMarriage" class="minimal">
                                ไม่ได้ทำ
                            </label>
                            <label class="col-lg-2 col-sm-2">
                                <input type="radio" name="XVCusAddressMarriage" class="minimal">
